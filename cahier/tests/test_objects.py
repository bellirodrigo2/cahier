...
def test_factories_assetserver_hierarchy():
    ...
    assert ObjEnum.assetserver.parent_of(ObjEnum.view) == False
    assert ObjEnum.assetserver.parent_of(ObjEnum.node) == False
    assert ObjEnum.assetserver.parent_of(ObjEnum.item) == False
    assert ObjEnum.assetserver.parent_of(ObjEnum.assetserver) == False


def test_factories_database_hierarchy():
    assert ObjEnum.database.parent_of(ObjEnum.assetserver) == False
    assert ObjEnum.database.parent_of(ObjEnum.database) == False
    assert ObjEnum.database.parent_of(ObjEnum.view)
    assert ObjEnum.database.parent_of(ObjEnum.node)
    assert ObjEnum.database.parent_of(ObjEnum.item) == False
    
    
def test_factories_view_hierarchy():
    assert ObjEnum.view.parent_of(ObjEnum.assetserver) == False
    assert ObjEnum.view.parent_of(ObjEnum.database) == False
    assert ObjEnum.view.parent_of(ObjEnum.view) == False
    assert ObjEnum.view.parent_of(ObjEnum.node) == False
    assert ObjEnum.view.parent_of(ObjEnum.item) == False
    
    
def test_factories_node_hierarchy():
    assert ObjEnum.node.parent_of(ObjEnum.assetserver) == False
    assert ObjEnum.node.parent_of(ObjEnum.database) == False
    assert ObjEnum.node.parent_of(ObjEnum.view) == False
    assert ObjEnum.node.parent_of(ObjEnum.node)
    assert ObjEnum.node.parent_of(ObjEnum.item)
    
    
def test_factories_item_hierarchy():
    assert ObjEnum.item.parent_of(ObjEnum.assetserver) == False
    assert ObjEnum.item.parent_of(ObjEnum.database) == False
    assert ObjEnum.item.parent_of(ObjEnum.view) == False
    assert ObjEnum.item.parent_of(ObjEnum.node) == False
